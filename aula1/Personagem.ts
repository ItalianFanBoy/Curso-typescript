...
// let nome = "Jon";
 ...
 //let sansa: Personagem3;
//sansa= new Personagem3();
...
export default class Personagem {  // outra forma de declaração - nesse modelo exijo que os argmentos sejam preenchidos
        constructor (
            public nome: string, 
